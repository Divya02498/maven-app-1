...
<body>
    <div class="container">
        <div class="content">
            ...
            <p>My name is <span class="highlighted-name">Irshad Ahmad</span>, I am an <span class="trainer">I am ITIL Certified along with AWS and Security Analyst</span>.</p>
            <p class="curriculum"><em>My Recommended curriculum to become a Cloud Security Engineer:</em></p>
