...
<body>
    <div class="container">
        <div class="content">
            ...
            <p>My name is <span class="highlighted-name">Divya Madhav Amblekar</span>, I am an <span class="trainer"> AWS, DevOps Engineer</span>.</p>
            <p class="curriculum"><em>My Recommended curriculum to become a Cloud DevOps Engineer:</em></p>
